...
const ShareModal: React.FC<ShareModalProps> = ({onClose,isOpen,  tourTitle, tourDescription }) => {
  ...
  const handleShare = (platform: string) => {
    ...
    const title = encodeURIComponent(tourTitle || 'Check out this tour');
    const description = encodeURIComponent(tourDescription || '');
    ...
    switch(platform) {
      ...
      case 'instagram':
        ...
        toast({
          ...
          description: "Link copied! You can paste it in your Instagram post or story.",
        });
        return;
      case 'tiktok':
        handleCopyLink();
        toast({
          ...
          description: "Link copied! You can paste it in your TikTok video description.",
        });
        return;
      case 'whatsapp':
    ...
    >
      ...
      >
        ...
        <div className="flex items-center justify-between mb-6">
          <h3 className="text-2xl font-bold text-gray-900">Share this tour</h3>
          <button 
            onClick={onClose}
        ...
        <div className="grid grid-cols-2 gap-4 mb-6">
          ...
          <button
            ...
            className="flex items-center gap-3 p-4 border-2 border-gray-200 rounded-xl hover:border-blue-600 hover:bg-blue-50 transition-all group"
          >
          ...
          <button
            ...
            className="flex items-center gap-3 p-4 border-2 border-gray-200 rounded-xl hover:border-blue-700 hover:bg-blue-50 transition-all group"
          >
          ...
          <button
            ...
            className="flex items-center gap-3 p-4 border-2 border-gray-200 rounded-xl hover:border-pink-600 hover:bg-pink-50 transition-all group"
          >
          ...
          <button
            ...
            className="flex items-center gap-3 p-4 border-2 border-gray-200 rounded-xl hover:border-black hover:bg-gray-50 transition-all group"
          >
            ...
            <span className="font-semibold text-gray-700 group-hover:text-black">TikTok</span>
          </button>
          ...
          >
            ...
            <span className="font-semibold text-gray-700 group-hover:text-blue-400">Twitter</span>
          </button>
          ...
          >
            ...
            <span className="font-semibold text-gray-700 group-hover:text-green-500">WhatsApp</span>
          </button>
        </div>
        ...
        <div className="border-t pt-6">
          ...
          <div className="flex gap-2">
            ...
            <Button
              ...
              className={`px-6 ${linkCopied ? 'bg-green-500 hover:bg-green-600' : 'bg-blue-600 hover:bg-blue-700'}`}
            >
              {linkCopied ? (
                <>
